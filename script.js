            ...
            return `
                <div class="ranking-item">
                    ...
                    <div class="ranking-info">
                        ...
                        <div class="ranking-details">${participant.curso} - ${participant.carrera}</div>
                    </div>
...
function compareTime(a, b) {
    // Convertir tiempo MM:SS:ms a milisegundos para comparar
    const timeToMs = (timeStr) => {
        const parts = timeStr.split(':');
        const minutes = parseInt(parts[0], 10) * 60000;
        const seconds = parseInt(parts[1], 10) * 1000;
        const milliseconds = parseInt(parts[2], 10);
        return minutes + seconds + milliseconds;
    };
    
    return timeToMs(a.tiempo) - timeToMs(b.tiempo);
}
...
function exportToCSV() {
    ...
    const headers = ["Nombre", "Apellido", "RUT", "Edad", "Curso", "Carrera de Interés", "Telefono", "Tiempo", "Nivel", "Fecha"];
